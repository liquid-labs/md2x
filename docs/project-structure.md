...
Holds the project's prose documentation beyond `README.md`: the full specification (`docs/md2x-spec.md`) and this project-structure reference. Further docs (e.g. `docs/architecture.md`) would land here as the project grows.
